...
static uint8_t manufacturer_data[]= {0x4c, 0x00};
static uint8_t service_data[]={0xFF,0x00,0x19,0x68,0x65};
...
static esp_ble_adv_data_t adv_data = {
    ...
    .max_interval        = 0x40,
    // .appearance          = 0x00,
    .manufacturer_len    = sizeof(manufacturer_data),    //TEST_MANUFACTURER_DATA_LEN,
    .p_manufacturer_data = manufacturer_data, //test_manufacturer,
...
static const uint8_t esp32_respond[]  = "Please input ID of each team member:";
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
{
    ...
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&CHAR_2_LONG_WR, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
      LONG_CHAR_VAL_LEN, sizeof(esp32_respond), (uint8_t *)esp32_respond}},
